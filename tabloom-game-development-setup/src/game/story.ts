...
export const SCENES: Scene[] = [
  ...
  /* --------------- 26 · THE CONFESSION --------------- */
  {
    ...
    beats: [
      ...
      fx("longFade", 5200),
      { k: "hold", ms: 4200 },
      { k: "card", kicker: "ACT VIII", text: "THE PROOF HE WASN'T READY FOR", sub: "complete · the fourth", style: "big" },
    ],
  },

  /* ===================== ACT IX — WHAT VEYR KNOWS THAT ARI DOESN'T ===================== */

  /* --------------- 27 · ARRIVAL AT THE HEARTWOOD --------------- */
  {
    id: "act9-arrival",
    branch: "void",
    title: "aevum://heartwood",
    meta: { url: "aevum://heartwood/the-siege", tag: "the core · the last door", clock: "—" },
    beats: [
      { k: "card", kicker: "ACT IX", text: "WHAT VEYR KNOWS THAT ARI DOESN'T", sub: "the heartwood siege", style: "big" },
      set("rootReal", false),
      set("site", false),
      set("sennSmall", false),
      set("siege"),
      set("veyrHere", false),
      set("veyrBeaten", false),
      set("nullrootOffered", false),
      codex("heartwood"),
      { k: "hold", ms: 3200 },
      n("The Heartwood. Not a branch — the place the branches are for."),
      n("It goes up past where the eye agrees to follow, and it has been cut. Long vertical wounds in bark the size of counties, each one weeping the same teal-gold light that runs under every world Ari has ever stood in."),
      n("The causeway is littered. The sky has holes in it."),
      d("ari", "He's been busy."),
      d("senn", "He's been thorough. You know the difference by now."),
    ],
  },
  ...
  /* --------------- 28 · THE TWO-SHOT --------------- */
  {
    ...
    branch: "void",
    title: "aevum://heartwood",
    meta: { url: "aevum://heartwood/the-siege", tag: "the grieving father", clock: "—" },
    beats: [
      set("veyrHere"),
      { k: "hold", ms: 3600 },
      n("He does not arrive so much as become noticeable — a tall stillness at the far end of the causeway that was probably there the whole time."),
      { k: "hold", ms: 2600 },
      codex("nullroot"),
      d("veyr", "Ari Vaan. You're taller than the last one."),
      d("ari", "You know what I am."),
      d("veyr", "I know what you're for. That's a different and sadder thing."),
      codex("loneliness"),
      d("veyr", "You'll want me to be a monster. Try, if it helps. But say the charge out loud first — what is it you think I'm doing?"),
      d("ari", "Killing worlds."),
      d("veyr", "I do not kill worlds. I end their loneliness."),
      { k: "hold", ms: 2800 },
      d("veyr", "Fifteen rooms. In every one of them a girl dies at eleven years old, and nobody in that room has ever heard of the other fourteen. Fifteen separate deaths that never touch. Nobody witnesses. Nobody carries it across."),
      d("veyr", "Collapse the rooms and she dies once. Once, properly, remembered by everything at the same time. That is not murder, boy. That is a funeral finally being allowed to happen."),
      d("ari", "And everyone standing in the rooms?"),
      d("veyr", "Comes home. All of them. Into one world that finally knows what it lost."),
      { k: "hold", ms: 2400 },
      d("veyr", "Every reality denied you, Ari. Used you, buried you, started over. Not one of them ever answered you honestly. Why defend them?"),
      { k: "hold", ms: 2600 },
      d("ari", "…A man on a frozen field told me something, near the end of his hundredth year of dying."),
      d("ari", "He said some things are supposed to end once and mean it. I thought he was talking about himself."),
      d("ari", "He was talking about you. You're not ending her death, Veyr. You're the only person in fifteen worlds who won't let it finish."),
      { k: "hold", ms: 2200 },
      d("veyr", "…Then we'll have to do the loud part first."),
      { k: "veyrFight" },
      set("veyrBeaten"),
    ],
  },
  ...
  /* --------------- 29 · THE TRUTH --------------- */
  {
    ...
    branch: "void",
    title: "aevum://heartwood",
    meta: { url: "aevum://heartwood/the-siege", tag: "this is not a fight anymore", clock: "—" },
    beats: [
      codex("incentive"),
      { k: "truth" },
      set("nullrootOffered"),
      { k: "hold", ms: 2600 },
      d("senn", "Ari. Ari, look at me. Don't pick it up."),
      d("senn", "Please."),
      { k: "hold", ms: 2400 },
      n("It lies there between them, point-down in the wounded ground, doing what it has always done: refusing to be argued with."),
      n("Nobody reaches for it."),
      { k: "hold", ms: 3400 },
      n("Not yet."),
      fx("longFade", 5600),
      { k: "hold", ms: 4400 },
