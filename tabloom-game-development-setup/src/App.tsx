...
function loadMeta(): MetaSave {
  try {
    ...
    if (raw) return { codex: [], act1Complete: false, muted: false, ...JSON.parse(raw) };
  } catch {
    /* ignore */
  }
  return { codex: [], act1Complete: false, muted: false };
}
